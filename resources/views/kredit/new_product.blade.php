                ...
                <div class="card-body">
                    <form action="{{ url('/product/create') }}" method="post" name="create_form">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 space-bottom">
                                <div class="row">
                                    <label class="col-12 font-weight-bold col-form-label">Harga Beli<span
                                            class="text-danger">*</span></label>
                                    <div class="col-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control number-input" name="harga_beli"
                        ...
                        @if ($supply_system->status == true)
                            <div class="form-group row">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    <select class="form-control" name="satuan_produk" required>
                                                        @foreach (\App\Unit::select('id', 'name')->get() as $unit)
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="row">
                                        <label class="col-12 font-weight-bold col-form-label">Supplier <span
                                                class="text-danger">*</span></label>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12 error-notice" id="supplier_error"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-6 col-md-6 col-sm-12 space-bottom d-none">
                                    <div class="row">
                                        ...
                                        <div class="col-12 error-notice" id="ppn_error"></div>
                                    </div>
                                </div>
                            </div>
                        @endif
                        <div class="form-group row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row">
                                    <label class="col-12 font-weight-bold col-form-label">Harga Ecer <span
                                            class="text-danger">*</span></label>
                                    <div class="col-12">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                            ...
                                            <input type="text" class="form-control number-input" name="harga_ecer"
                                                placeholder="Masukkan Harga">
                                        </div>
                                    </div>
                                    <div class="col-12 error-notice" id="harga_ecer_error"></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row">
                                    <label class="col-12 font-weight-bold col-form-label">Harga Grosir <span
                                            class="text-danger">*</span></label>
                                    <div class="col-12">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                            ...
                                            <input type="text" class="form-control number-input" name="harga_grosir"
                                                placeholder="Masukkan Harga">
                                        </div>
                                    </div>
                                    <div class="col-12 error-notice" id="harga_grosir_error"></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row">
                                    <label class="col-12 font-weight-bold col-form-label">Harga Khusus <span
                                            class="text-danger">*</span></label>
                                    <div class="col-12">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                            ...
                                            <input type="text" class="form-control number-input" name="harga_khusus"
                                                placeholder="Masukkan Harga">
                                        </div>
                                    </div>
                                    <div class="col-12 error-notice" id="harga_khusus_error"></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row">
                                    <label class="col-12 font-weight-bold col-form-label">Harga Extra <span
                                            class="text-danger">*</span></label>
                                    <div class="col-12">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                            ...
                                            <input type="text" class="form-control number-input" name="harga_extra"
                                                placeholder="Masukkan Harga">
                                        </div>
                                    </div>
                                    <div class="col-12 error-notice" id="harga_extra_error"></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
