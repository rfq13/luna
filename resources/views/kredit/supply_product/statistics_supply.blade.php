            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('/supply/statistics/export') }}" name="export_form" method="POST"
                            target="_blank">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    @foreach ($products as $product)
                                        <li
                                            ...
                                            <div class="d-flex align-items-center">
                                                <span class="ammount-box-1 bg-secondary mr-1"><i
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-12 d-flex justify-content-start align-items-center info-barang-group">
                                    <p class="mr-3 p-info-barang info-nama-barang">{{ $products->first()->nama_barang }}
                                    </p>
                                    ...
                                    <span class="dot mr-3"><i class="mdi mdi-checkbox-blank-circle"></i></span>
                                    @php
                                        $total_pemasok = \App\Supplier::select('id')->count();
                                    @endphp
                                    <p class="p-info-barang p-sisa">{{ $total_pemasok }} Pemasok</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <ul class="percent-info font-weight-bold d-flex justify-content-start">
                                        <li class="mr-4"><i
                                                class="mdi mdi-checkbox-blank-circle mr-2 text-success"></i> Penurunan
                                            Harga</li>
                                        <li><i class="mdi mdi-checkbox-blank-circle mr-2 text-danger"></i> Kenaikan Harga
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-12 table-responsive">
                            <table class="table table-custom">
                                ...
                                <tbody>
                                    @php
                                        $supply_products = \App\SupplyHistory::where('product_id', '=', $products->first()->id)
                                            ->select('*')
                                            // ->with('supplier')
                                            ...
                                            ->get();
                                    @endphp
                                    @include('manage_product.supply_product.statistics_table')
                                </tbody>
                            </table>
                        </div>
                    </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                labels: [
                    @foreach ($supply_products->reverse()->take(7) as $supply)
                ...
                success: function(response) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            $('.p-sisa').html(data);
                            $.ajax({
                                url: "{{ url('/supply/statistics/table') }}/" +
                                    kode_barang,
                                method: "GET",
                                success: function(data) {
                                    $('tbody').html(data);
