                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mt-3">
                                    ...
                                    <form action="{{ url('/supply/import') }}" method="post" name="import_form"
                                        ...
                                        @csrf
                                        <input type="hidden" class="form-control" name="supplier_id" id="supplier_id_import">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $('#supplier_opt').selectpicker({
            ...
            $('#supplier_id_import').val(supplier_id);
        ...
        $(document).on('click', '.btn-tambah', function(e) {
            ...
            var supplier = {
                val: $("#supplier_opt").val(),
                name: $("#supplier_opt option:selected").text()
            };
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (check == 0) {
                            ...
                            $('input[name=ppn]').val('');
                            // $('#supplier_opt').val('').selectpicker("refresh");
                            $('tbody').append(`
								<tr>
									<td>
										<span class="kd-barang-field">
											${response.product.kode_barang}
										</span>
										<span class="nama-barang-field">${response.product.nama_barang}</span>
									</td>
									<td align="center">
										${jumlah}
									</td>
									<td align="center">
										Rp. ${parseInt(harga_beli).toLocaleString()}
									</td>
									${
                                        ""
                                        // <td>
									...
									<td>
										...
										<div class="form-group" hidden="">
											<input type="text" class="form-control" name="kode_barang_supply[]" value="${response.product.kode_barang}">
											<input type="text" class="form-control" name="jumlah_supply[]" value="${jumlah}">
											<input type="text" class="form-control" name="harga_beli_supply[]" value="${harga_beli}">
											<input type="text" class="form-control" name="ppn[]" value="${ppn}">
										</div>
									</td>
								</tr>`);
