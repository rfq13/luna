        ...
        <div class="col-12">
            <div class="page-header d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex justify-content-start">
                    ...
                    <a href="{{ url('/product/distribution/create') }}" class="btn btn-icons btn-inverse-primary btn-new ml-2">
                        ...
                        <div class="modal-body" id="edit-modal-body">
                            ...
                            <div class="form-group row" @if ($supply_system->status == false) hidden="" @endif>
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control number-input input-notzero" name="stok">
                                        <div class="input-group-append">
                                        ...
                                        <tr>
                                            ...
                                            @if ($supply_system->status == true)
                                                <td>
                                                    {{ $product->stok }}
                                                    <span
                                                        class="badge badge-secondary badge-sm">{{ $product->satuan->name }}</span>
                                                </td>
                                            @endif
