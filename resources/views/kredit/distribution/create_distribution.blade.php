...
<div class="row page-title-header">
  <div class="col-12">
    <div class="page-header d-flex justify-content-start align-items-center">
      <h4 class="page-title">Distribusi Barang</h4>
    </div>
  </div>
</div>
<div class="row modal-group">
  ...
  <div class="modal fade" id="tableModal" tabindex="-1" role="dialog" aria-labelledby="tableModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="tableModalLabel">Distribusi Barang</h5>
          <button type="button" class="close close-btn" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<form method="POST" name="transaction_form" action="{{ url('/distribution') }}">
  @csrf
  <div class="row">
              ...
              <div class="row">
                <div class="col-12 d-flex justify-content-between align-items-center transaction-header">
                  <div class="d-flex justify-content-start align-items-center">
                    ...
                    @php
                        $kode_distribusi = date('dmYHis');
                    @endphp
                    <div class="transaction-code ml-3">
                      <p class="m-0 text-white">Kode Distribusi</p>
                      <p class="m-0 text-white">D{{ $kode_distribusi }}</p>
                      <input type="hidden" name="kode_distribusi" value="T{{ $kode_distribusi }}">
                    </div>
                  </div>
          ...
          <div class="row">
            ...
            <div class="col-12 mt-4">
              <table class="table-payment-2">
                <tr>
                    <td class="text-left">
                        <span class="subtotal-td">Total</span>
                        {{-- <span class="jml-barang-td">0 Barang</span> --}}
                    </td>
                    {{-- <td class="text-right nilai-subtotal1-td">Rp. 0</td> --}}
                    <td>
                        <input type="hidden" name="total_barang" id="total_barang" value="0">
                        <span class="text-right jml-barang-td" style="color: black;font-size:16px !important">0 Barang</span>
                    </td>
                    <td hidden="">
                      <input type="text" class="nilai-subtotal2-td" name="subtotal" value="0">
                    </td>
                </tr>
                {{-- <tr>
                  <td class="text-left">
            ...
            <div class="col-12 mt-2">
              <table class="table-payment-3">
                ...
                <tr>
                  <td class="text-right">
                    {{-- <button class="btn btn-bayar" type="button">Submit</button> --}}
                    <button class="btn" type="button" onclick="validateTr(event)" style="background-color: #465ef2;color:white">Submit</button>
                  </td>
                </tr>
              </table>
            </div>
