<ul class="nav">
    ...
    @php
        $access = \App\Acces::where('user', auth()->id())->first();
    @endphp
    ...
    @endif
    @if ($access->kelola_cabang == 1)
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#kelola_cabang" aria-expanded="false"
                aria-controls="kelola_cabang">
                <span class="menu-title">Kelola Cabang</span>
                <i class="menu-arrow"></i>
            </a>
        ...
        @if (\App\Supply_system::first()->status == true)
            <li class="nav-item">
                ...
                <div class="collapse" id="kelola_barang">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('product.settings') }}">Pengaturan</a>
                        </li>
                        <li class="nav-item">
