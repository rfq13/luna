                                        ...
                                        <table class="table table-custom">
                                            ...
                                            @foreach ($supplies as $supply)
                                                <tr>
                                                    <td class="td-1">
                                                        <span
                                                            class="d-block font-weight-bold big-font">{{ $supply->product->nama_barang }}</span>
                                                        <span
                                                            class="d-block mt-2 txt-light">{{ date('d M, Y', strtotime($supply->created_at)) . ' pada ' . date('H:i', strtotime($supply->created_at)) }}</span>
                                                    </td>
                                                    <td class="td-2 font-weight-bold">{{ $supply->product->kode_barang }}
                                                    </td>
                                                    <td class="td-3 font-weight-bold">
                                                        {{ $supply->jumlah }}
                                                        <span
                                                            class="badge badge-secondary badge-sm">{{ $supply->product->satuan->name }}</span>
                                                    </td>
                                                    ...
                                                    <td class="font-weight-bold">{{ $supply->supplier->name }}</td>
                                                </tr>
                                            @endforeach
                                        </table>
                                    </div>
